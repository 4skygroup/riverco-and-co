            ...
            {OUTILS_ECOSYSTEME.map((outil, index) => (
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  ...
                  {/* NOUVEAU : Label "En attente" */}
                  {outil.isPending && (
                    <span className="px-4 py-1 border border-orange-500/50 bg-orange-500/10 text-orange-500 text-xs font-medium rounded-md uppercase tracking-wider">
                      En attente
                    </span>
                  )}
                </div>
