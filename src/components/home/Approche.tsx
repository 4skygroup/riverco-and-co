        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-8 md:gap-10">
          ...
          <div className="flex flex-col gap-4 text-left w-full">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
              Ce qui caractérise{" "}
              <span className="text-[#FF0000]">l'approche de RIVERCO & CO</span>
            </h2>
            <p className="text-gray-300 text-sm md:text-base leading-relaxed max-w-4xl">
              En tant qu'agence spécialisée en développement commercial, nos
              équipes effectuent quotidiennement des campagnes de prospection à
              froid afin d'obtenir des rendez-vous pour nos clients.
            </p>
          </div>
