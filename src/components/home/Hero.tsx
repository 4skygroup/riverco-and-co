        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="flex flex-col items-start text-left gap-6 max-w-2xl">
            ...
            <p className="text-gray-400 text-sm md:text-base lg:text-lg max-w-xl leading-relaxed">
              Déployez une force commerciale d'élite à l'international sans la
              structure. Riverco & Co prend en charge l'intégralité de votre
            ...
            <Link
              to="/contact"
              className="mt-4 flex w-fit items-center gap-3 bg-black border border-white/30 hover:border-white/80 active:scale-98 transition-all text-white font-medium text-sm md:text-base px-6 py-3.5 rounded-full tracking-wide"
            >
